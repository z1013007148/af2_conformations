...
def deal(args):
    ...
    #             continue
    #         more_muts[j] = random.sample("ACDEFGHIKLMNPQRSTVWY-", 1)[0]

    for n_model in range(20):
        random_muts = {}
        for idx in random.sample(muts.keys(), int(len(muts.keys()) * random_threshold)):  # 随机取threshold%的残基
...
if __name__ == '__main__':
    output_folder = "91*2testset_runall2"
